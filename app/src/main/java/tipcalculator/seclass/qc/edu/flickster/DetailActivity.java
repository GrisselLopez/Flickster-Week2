...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyBTUSWU-6ZEWjSaI5_F6sqD-wShcQRxGJc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client.get(String.format(TRAILERS_API, movie.getMovieId()),new JsonHttpResponseHandler(){
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                Log.e("youtubeDeatail", "ON Failure youtube");
            }
        });
    ...
    private void initializeYoutube(final String youtubeKey) {
        youTubePlayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Log.d("youtubeDeatail", "ON Failure youtube");
               // Log.d("smile", "on init failiure ");
            }
        });
    }
}
